...
kwriteconfig5 --file $meta --group ContrastEffect --key enabled true
#对比度,越低越亮
kwriteconfig5 --file $meta --group ContrastEffect --key contrast 1.0
kwriteconfig5 --file $meta --group ContrastEffect --key intensity 1.2
#2.0是个差不多的数值,饱和度更高就会出现明显色块,颜色过度不再平滑
kwriteconfig5 --file $meta --group ContrastEffect --key saturation 2.0
